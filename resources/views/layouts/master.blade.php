...
<head>
    ...
    <title>@yield('title', 'Reading Rewards')</title>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            <div class="navbar-header">
                <img class="navbar-logo" src="/img/logo.jpg" alt="Reading Rewards" />
                <h1 class="navbar-title">Reading Rewards</h1>
            </div>
            ...
            <div class="navbar-icons">
                <ul>
                    ...
                    @guest
                    <li class="mx-2"><a class="text-decoration-none" href="/register" style="font-size: 1.2rem;">Regístrate</a></li>
                    <li class="mx-2"><a class="text-decoration-none" href="/login" style="font-size: 1.2rem;">Iniciar Sesión</a></li>
                    @endguest
                    @auth
                    <li class="mx-2"><a class="text-decoration-none" href="/logout" style="font-size: 1.2rem;">Cerrar Sesión</a></li>
                    @endauth
                </ul>
            </div>
